...
public class Area
{
	...
	{
		if (pos2 != null && !pos1.getWorld().equals(pos2.getWorld())) throw new IllegalArgumentException("Area pos1 and pos2 Locations must refer to the same world");
		else this.pos1 = pos1;
		if (pos2 != null) calculateSize();
	}
	...
	{
		if (pos1 != null && !pos2.getWorld().equals(pos1.getWorld())) throw new IllegalArgumentException("Area pos1 and pos2 Locations must refer to the same world");
		this.pos2 = pos2;
		if (pos1 != null) calculateSize();
	}
	...
	{
		if (!isValid() || !pos1.getWorld().equals(pos2.getWorld())) return null;
		...
		BlockDisplayEditor.getInstance().getLogger().info("Calculated center of " + Utility.locationAsString(pos1) + " to " + Utility.locationAsString(pos2) + " as " + Utility.locationAsString(volume % 2 == 0 ? midpointBase.toBlockLocation() : midpointBase.toCenterLocation()));
	...
	{
		return containsLocation(area.pos1, ignoreY) && containsLocation(area.pos2, ignoreY);
	}
